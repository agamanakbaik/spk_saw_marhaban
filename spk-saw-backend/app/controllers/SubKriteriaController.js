...
 * - 'keterangan' sekarang diambil dari req.body.
 * - 'keterangan' sekarang dikirim ke Model saat create dan update.
 */
...
    // ▼▼▼ PERBAIKAN 1: Ambil 'keterangan' dari req.body ▼▼▼
...
    try {
        // ▼▼▼ PERBAIKAN 2: Kirim 'keterangan' ke Model ▼▼▼
        const newSubKriteria = await SubKriteriaModel.create(kriteria_id, nama, cleanNilai, keterangan);
...
    const { id } = req.params;
    // ▼▼▼ PERBAIKAN 1: Ambil 'keterangan' dari req.body ▼▼▼
    const { nama, nilai, keterangan } = req.body; // kriteria_id tidak di-update
...
    try {
        // ▼▼▼ PERBAIKAN 2: Kirim 'keterangan' ke Model ▼▼▼
        const updatedSubKriteria = await SubKriteriaModel.update(id, nama, cleanNilai, keterangan);
